...
debug: CXXFLAGS += -g
debug: rebuild
main_window: main.o main_window.o container.o scoop.o toppings.o manager.o controller.o dialogs.o item.o customer.o  person.o server.o
	$(CXX) $(CXXFLAGS) -o mice main.o main_window.o container.o scoop.o toppings.o manager.o controller.o item.o customer.o  person.o server.o `/usr/bin/pkg-config gtkmm-3.0 --cflags --libs`
	./mice
