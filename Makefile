...
debug: CXXFLAGS += -g
debug: main_window
main_window: main.o main_window.o container.o scoop.o toppings.o manager.o controller.o dialogs.o item.o serving.o
	$(CXX) $(CXXFLAGS) -o mice main.o main_window.o container.o scoop.o toppings.o manager.o controller.o dialogs.o item.o serving.o `/usr/bin/pkg-config gtkmm-3.0 --cflags --libs`
	./mice
